...
# DESCRIPTION: Installs Visual C++ 2022 (ARM64) via WinGet. Use -Undo to uninstall.
# UNDOABLE: Yes
# UNDO_DESC: Uninstalls Visual C++ 2022 (ARM64) using WinGet.
#
...
$AppName = "Visual C++ 2022 (ARM64)"
$PackageIds = @("Microsoft.VCRedist.2015+.arm64")
$Source = "winget"
