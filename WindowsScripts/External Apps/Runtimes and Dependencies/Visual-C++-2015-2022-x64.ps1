...
# DESCRIPTION: Installs Visual C++ 2015-2022 (x64) via WinGet. Use -Undo to uninstall.
# UNDOABLE: Yes
# UNDO_DESC: Uninstalls Visual C++ 2015-2022 (x64) using WinGet.
#
...
$AppName = "Visual C++ 2015-2022 (x64)"
$PackageIds = @("Microsoft.VCRedist.2015+.x64")
$Source = "winget"
