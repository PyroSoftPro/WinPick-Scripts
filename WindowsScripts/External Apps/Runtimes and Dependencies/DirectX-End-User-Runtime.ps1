...
# DESCRIPTION: Installs DirectX End-User Runtime via WinGet. Use -Undo to uninstall.
# UNDOABLE: Yes
# UNDO_DESC: Uninstalls DirectX End-User Runtime using WinGet.
#
...
$AppName = "DirectX End-User Runtime"
$PackageIds = @("Microsoft.DirectX")
$Source = "winget"
