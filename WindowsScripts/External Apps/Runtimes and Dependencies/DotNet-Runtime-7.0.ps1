...
# DESCRIPTION: Installs Microsoft .NET Runtime 7.0 via WinGet. Use -Undo to uninstall.
# UNDOABLE: Yes
# UNDO_DESC: Uninstalls Microsoft .NET Runtime 7.0 using WinGet.
#
...
$AppName = "Microsoft .NET Runtime 7.0"
$PackageIds = @("Microsoft.DotNet.Runtime.7")
$Source = "winget"
