...
# DESCRIPTION: Installs Microsoft .NET Runtime 3.1 via WinGet. Use -Undo to uninstall.
# UNDOABLE: Yes
# UNDO_DESC: Uninstalls Microsoft .NET Runtime 3.1 using WinGet.
#
...
$AppName = "Microsoft .NET Runtime 3.1"
$PackageIds = @("Microsoft.DotNet.Runtime.3_1")
$Source = "winget"
