...
# DESCRIPTION: Installs Visual C++ 2008 (x86) via WinGet. Use -Undo to uninstall.
# UNDOABLE: Yes
# UNDO_DESC: Uninstalls Visual C++ 2008 (x86) using WinGet.
#
...
$AppName = "Visual C++ 2008 (x86)"
$PackageIds = @("Microsoft.VCRedist.2008.x86")
$Source = "winget"
