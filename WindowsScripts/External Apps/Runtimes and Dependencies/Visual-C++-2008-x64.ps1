...
# DESCRIPTION: Installs Visual C++ 2008 (x64) via WinGet. Use -Undo to uninstall.
# UNDOABLE: Yes
# UNDO_DESC: Uninstalls Visual C++ 2008 (x64) using WinGet.
#
...
$AppName = "Visual C++ 2008 (x64)"
$PackageIds = @("Microsoft.VCRedist.2008.x64")
$Source = "winget"
