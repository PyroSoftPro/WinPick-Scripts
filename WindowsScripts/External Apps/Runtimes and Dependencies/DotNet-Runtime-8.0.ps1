...
# DESCRIPTION: Installs Microsoft .NET Runtime 8.0 via WinGet. Use -Undo to uninstall.
# UNDOABLE: Yes
# UNDO_DESC: Uninstalls Microsoft .NET Runtime 8.0 using WinGet.
#
...
$AppName = "Microsoft .NET Runtime 8.0"
$PackageIds = @("Microsoft.DotNet.Runtime.8")
$Source = "winget"
