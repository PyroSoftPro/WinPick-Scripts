...
# DESCRIPTION: Installs .NET Framework 4.8.1 Developer Pack via WinGet. Use -Undo to uninstall.
# UNDOABLE: Yes
# UNDO_DESC: Uninstalls .NET Framework 4.8.1 Developer Pack using WinGet.
#
...
$AppName = ".NET Framework 4.8.1"
$PackageIds = @("Microsoft.DotNet.Framework.DeveloperPack_4")
$Source = "winget"
