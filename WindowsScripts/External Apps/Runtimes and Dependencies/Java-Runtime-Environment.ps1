...
# DESCRIPTION: Installs Java Runtime Environment via WinGet. Use -Undo to uninstall.
# UNDOABLE: Yes
# UNDO_DESC: Uninstalls Java Runtime Environment using WinGet.
#
...
$PackageIds = @("Oracle.JavaRuntimeEnvironment")
$Source = "winget"
