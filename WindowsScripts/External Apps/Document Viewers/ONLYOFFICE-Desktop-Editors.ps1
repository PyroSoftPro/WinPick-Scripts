...
# DESCRIPTION: Installs ONLYOFFICE Desktop Editors via WinGet. Use -Undo to uninstall.
# UNDOABLE: Yes
# UNDO_DESC: Uninstalls ONLYOFFICE Desktop Editors using WinGet.
#
...
$AppName = "ONLYOFFICE Desktop Editors"
$PackageIds = @("ONLYOFFICE.DesktopEditors")
$Source = "winget"
