# NAME: Foxit Reader
# DESCRIPTION: Installs Foxit Reader via WinGet (Microsoft Store). Use -Undo to uninstall.
# UNDOABLE: Yes
# UNDO_DESC: Uninstalls Foxit Reader using WinGet (Microsoft Store).
#
