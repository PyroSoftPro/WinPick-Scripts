# NAME: LibreOffice
# DESCRIPTION: Installs LibreOffice via WinGet. Use -Undo to uninstall.
# UNDOABLE: Yes
# UNDO_DESC: Uninstalls LibreOffice using WinGet.
#
...
$AppName = "LibreOffice"
$PackageIds = @("TheDocumentFoundation.LibreOffice")
$Source = "winget"
