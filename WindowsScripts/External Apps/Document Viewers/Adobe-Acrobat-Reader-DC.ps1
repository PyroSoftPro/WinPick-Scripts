...
# DESCRIPTION: Installs Adobe Acrobat Reader DC via WinGet (Microsoft Store). Use -Undo to uninstall.
# UNDOABLE: Yes
# UNDO_DESC: Uninstalls Adobe Acrobat Reader DC using WinGet (Microsoft Store).
#
