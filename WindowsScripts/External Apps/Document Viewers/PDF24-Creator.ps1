# NAME: PDF24 Creator
# DESCRIPTION: Installs PDF24 Creator via WinGet. Use -Undo to uninstall.
# UNDOABLE: Yes
# UNDO_DESC: Uninstalls PDF24 Creator using WinGet.
#
...
$PackageIds = @("geeksoftwareGmbH.PDF24Creator")
$Source = "winget"
