# NAME: Chrome
# DESCRIPTION: Installs Google Chrome via WinGet. Use -Undo to uninstall.
# UNDOABLE: Yes
# UNDO_DESC: Uninstalls Google Chrome using WinGet.
#
...
$PackageIds = @("Google.Chrome", "Google.Chrome.EXE")
$Source = "winget"
