# NAME: DuckDuckGo
# DESCRIPTION: Installs DuckDuckGo Browser via WinGet. Use -Undo to uninstall.
# UNDOABLE: Yes
# UNDO_DESC: Uninstalls DuckDuckGo Browser using WinGet.
#
...
$AppName = "DuckDuckGo"
$PackageIds = @("DuckDuckGo.DesktopBrowser")
$Source = "winget"
