...
# DESCRIPTION: Installs Pale Moon Browser via WinGet. Use -Undo to uninstall.
# UNDOABLE: Yes
# UNDO_DESC: Uninstalls Pale Moon Browser using WinGet.
#
...
$AppName = "Pale Moon Browser"
$PackageIds = @("MoonchildProductions.PaleMoon")
$Source = "winget"
