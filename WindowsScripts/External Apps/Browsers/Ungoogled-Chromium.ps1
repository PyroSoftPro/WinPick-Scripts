...
# DESCRIPTION: Installs Ungoogled Chromium via WinGet. Use -Undo to uninstall.
# UNDOABLE: Yes
# UNDO_DESC: Uninstalls Ungoogled Chromium using WinGet.
#
...
$PackageIds = @("Eloston.Ungoogled-Chromium")
$Source = "winget"
