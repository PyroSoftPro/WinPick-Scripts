...
# DESCRIPTION: Installs Mullvad Browser via WinGet. Use -Undo to uninstall.
# UNDOABLE: Yes
# UNDO_DESC: Uninstalls Mullvad Browser using WinGet.
#
...
$AppName = "Mullvad Browser"
$PackageIds = @("MullvadVPN.MullvadBrowser")
$Source = "winget"
