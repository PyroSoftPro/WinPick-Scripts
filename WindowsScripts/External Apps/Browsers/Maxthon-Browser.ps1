...
# DESCRIPTION: Installs Maxthon Browser via WinGet. Use -Undo to uninstall.
# UNDOABLE: Yes
# UNDO_DESC: Uninstalls Maxthon Browser using WinGet.
#
...
$AppName = "Maxthon Browser"
$PackageIds = @("Maxthon.Maxthon")
$Source = "winget"
