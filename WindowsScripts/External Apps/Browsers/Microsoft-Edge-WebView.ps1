...
# DESCRIPTION: Installs Microsoft Edge WebView2 Runtime via WinGet. Use -Undo to uninstall.
# UNDOABLE: Yes
# UNDO_DESC: Uninstalls Microsoft Edge WebView2 Runtime using WinGet.
#
...
$AppName = "Microsoft Edge WebView"
$PackageIds = @("Microsoft.EdgeWebView2Runtime")
$Source = "winget"
