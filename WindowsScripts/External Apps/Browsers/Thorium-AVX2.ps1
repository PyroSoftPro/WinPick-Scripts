# NAME: Thorium AVX2
# DESCRIPTION: Installs Thorium AVX2 via WinGet. Use -Undo to uninstall.
# UNDOABLE: Yes
# UNDO_DESC: Uninstalls Thorium AVX2 using WinGet.
#
...
$AppName = "Thorium AVX2"
$PackageIds = @("Alex313031.Thorium.AVX2")
$Source = "winget"
