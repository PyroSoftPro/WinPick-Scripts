# NAME: Eclipse
# DESCRIPTION: Installs Eclipse via WinGet. Use -Undo to uninstall.
# UNDOABLE: Yes
# UNDO_DESC: Uninstalls Eclipse using WinGet.
#
...
$AppName = "Eclipse"
$PackageIds = @("EclipseFoundation.EclipseIDEforJavaDevelopers")
$Source = "winget"
