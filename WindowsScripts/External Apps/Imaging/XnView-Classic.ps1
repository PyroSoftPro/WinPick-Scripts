# NAME: XnView Classic
# DESCRIPTION: Installs XnView Classic via WinGet. Use -Undo to uninstall.
# UNDOABLE: Yes
# UNDO_DESC: Uninstalls XnView Classic using WinGet.
#
...
$AppName = "XnView Classic"
$PackageIds = @("XnSoft.XnView.Classic")
$Source = "winget"
