...
# DESCRIPTION: Installs HiBit Uninstaller via WinGet. Use -Undo to uninstall.
# UNDOABLE: Yes
# UNDO_DESC: Uninstalls HiBit Uninstaller using WinGet.
#
...
$AppName = "HiBit Uninstaller"
$PackageIds = @("HiBitSoftware.HiBitUninstaller")
$Source = "winget"
