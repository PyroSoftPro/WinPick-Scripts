# NAME: File Converter
# DESCRIPTION: Installs File Converter via WinGet. Use -Undo to uninstall.
# UNDOABLE: Yes
# UNDO_DESC: Uninstalls File Converter using WinGet.
#
...
$PackageIds = @("AdrienAllard.FileConverter")
$Source = "winget"
