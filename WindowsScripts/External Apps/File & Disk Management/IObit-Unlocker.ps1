# NAME: IObit Unlocker
# DESCRIPTION: Installs IObit Unlocker via WinGet. Use -Undo to uninstall.
# UNDOABLE: Yes
# UNDO_DESC: Uninstalls IObit Unlocker using WinGet.
#
...
$AppName = "IObit Unlocker"
$PackageIds = @("IObit.IObitUnlocker")
$Source = "winget"
