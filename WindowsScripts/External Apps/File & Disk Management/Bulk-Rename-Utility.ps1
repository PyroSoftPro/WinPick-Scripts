...
# DESCRIPTION: Installs Bulk Rename Utility via WinGet. Use -Undo to uninstall.
# UNDOABLE: Yes
# UNDO_DESC: Uninstalls Bulk Rename Utility using WinGet.
#
...
$PackageIds = @("TGRMNSoftware.BulkRenameUtility")
$Source = "winget"
