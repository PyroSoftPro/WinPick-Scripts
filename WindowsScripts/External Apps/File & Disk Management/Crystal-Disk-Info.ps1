...
# DESCRIPTION: Installs Crystal Disk Info via WinGet. Use -Undo to uninstall.
# UNDOABLE: Yes
# UNDO_DESC: Uninstalls Crystal Disk Info using WinGet.
#
...
$AppName = "Crystal Disk Info"
$PackageIds = @("WsSolInfor.CrystalDiskInfo")
$Source = "winget"
