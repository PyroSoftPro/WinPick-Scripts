# NAME: TreeSize Free
# DESCRIPTION: Installs TreeSize Free via WinGet. Use -Undo to uninstall.
# UNDOABLE: Yes
# UNDO_DESC: Uninstalls TreeSize Free using WinGet.
#
...
$PackageIds = @("JAMSoftware.TreeSize.Free")
$Source = "winget"
