...
# DESCRIPTION: Installs Epic Games Launcher via WinGet. Use -Undo to uninstall.
# UNDOABLE: Yes
# UNDO_DESC: Uninstalls Epic Games Launcher using WinGet.
#
...
$PackageIds = @("EpicGames.EpicGamesLauncher")
$Source = "winget"
