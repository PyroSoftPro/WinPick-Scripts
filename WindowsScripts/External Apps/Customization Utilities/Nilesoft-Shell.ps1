# NAME: Nilesoft Shell
# DESCRIPTION: Installs Nilesoft Shell via WinGet. Use -Undo to uninstall.
# UNDOABLE: Yes
# UNDO_DESC: Uninstalls Nilesoft Shell using WinGet.
#
...
$AppName = "Nilesoft Shell"
$PackageIds = @("Nilesoft.Shell")
$Source = "winget"
