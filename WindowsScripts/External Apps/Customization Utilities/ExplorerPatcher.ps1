...
# DESCRIPTION: Installs ExplorerPatcher via WinGet. Use -Undo to uninstall.
# UNDOABLE: Yes
# UNDO_DESC: Uninstalls ExplorerPatcher using WinGet.
#
...
$PackageIds = @("valinet.ExplorerPatcher")
$Source = "winget"
