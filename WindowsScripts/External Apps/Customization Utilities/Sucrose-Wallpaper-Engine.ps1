...
# DESCRIPTION: Installs Sucrose Wallpaper Engine via WinGet. Use -Undo to uninstall.
# UNDOABLE: Yes
# UNDO_DESC: Uninstalls Sucrose Wallpaper Engine using WinGet.
#
...
$AppName = "Sucrose Wallpaper Engine"
$PackageIds = @("Taiizor.SucroseWallpaperEngine")
$Source = "winget"
