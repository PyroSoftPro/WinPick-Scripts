...
# DESCRIPTION: Installs Lively Wallpaper via WinGet. Use -Undo to uninstall.
# UNDOABLE: Yes
# UNDO_DESC: Uninstalls Lively Wallpaper using WinGet.
#
...
$AppName = "Lively Wallpaper"
$PackageIds = @("rocksdanister.LivelyWallpaper")
$Source = "winget"
