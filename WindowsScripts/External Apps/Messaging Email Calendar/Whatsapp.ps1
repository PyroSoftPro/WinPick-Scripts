# NAME: Whatsapp
# DESCRIPTION: Installs Whatsapp via WinGet (Microsoft Store). Use -Undo to uninstall.
# UNDOABLE: Yes
# UNDO_DESC: Uninstalls Whatsapp using WinGet (Microsoft Store).
#
