...
# DESCRIPTION: Installs Hekasoft Backup & Restore via WinGet. Use -Undo to uninstall.
# UNDOABLE: Yes
# UNDO_DESC: Uninstalls Hekasoft Backup & Restore using WinGet.
#
...
$AppName = "Hekasoft Backup & Restore"
$PackageIds = @("Hekasoft.Backup-Restore")
$Source = "winget"
