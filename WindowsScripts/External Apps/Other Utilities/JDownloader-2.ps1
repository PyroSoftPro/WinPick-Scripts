# NAME: JDownloader 2
# DESCRIPTION: Installs JDownloader 2 via WinGet. Use -Undo to uninstall.
# UNDOABLE: Yes
# UNDO_DESC: Uninstalls JDownloader 2 using WinGet.
#
...
$AppName = "JDownloader 2"
$PackageIds = @("AppWork.JDownloader")
$Source = "winget"
