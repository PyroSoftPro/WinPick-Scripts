...
# DESCRIPTION: Installs Snappy Driver Installer Origin via WinGet. Use -Undo to uninstall.
# UNDOABLE: Yes
# UNDO_DESC: Uninstalls Snappy Driver Installer Origin using WinGet.
#
...
$AppName = "Snappy Driver Installer Origin"
$PackageIds = @("GlennDelahoy.SnappyDriverInstallerOrigin")
$Source = "winget"
