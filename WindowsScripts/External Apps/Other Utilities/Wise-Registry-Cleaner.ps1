...
# DESCRIPTION: Installs Wise Registry Cleaner via WinGet (Microsoft Store). Use -Undo to uninstall.
# UNDOABLE: Yes
# UNDO_DESC: Uninstalls Wise Registry Cleaner using WinGet (Microsoft Store).
#
...
$AppName = "Wise Registry Cleaner"
$PackageIds = @("XPDLS1XBTXVPP4")
$Source = "msstore"
