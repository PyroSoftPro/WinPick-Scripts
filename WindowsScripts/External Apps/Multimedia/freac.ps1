# NAME: fre:ac
# DESCRIPTION: Installs fre:ac via WinGet (Microsoft Store). Use -Undo to uninstall.
# UNDOABLE: Yes
# UNDO_DESC: Uninstalls fre:ac using WinGet (Microsoft Store).
#
