# NAME: MediaInfo GUI
# DESCRIPTION: Installs MediaInfo GUI via WinGet. Use -Undo to uninstall.
# UNDOABLE: Yes
# UNDO_DESC: Uninstalls MediaInfo GUI using WinGet.
#
...
$AppName = "MediaInfo GUI"
$PackageIds = @("MediaArea.MediaInfo.GUI")
$Source = "winget"
