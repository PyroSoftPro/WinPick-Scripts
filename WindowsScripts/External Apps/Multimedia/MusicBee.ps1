# NAME: MusicBee
# DESCRIPTION: Installs MusicBee via WinGet (Microsoft Store). Use -Undo to uninstall.
# UNDOABLE: Yes
# UNDO_DESC: Uninstalls MusicBee using WinGet (Microsoft Store).
#
