...
# DESCRIPTION: Installs K-Lite Codec Pack (Mega) via WinGet. Use -Undo to uninstall.
# UNDOABLE: Yes
# UNDO_DESC: Uninstalls K-Lite Codec Pack (Mega) using WinGet.
#
...
$AppName = "K-Lite Codec Pack (Mega)"
$PackageIds = @("CodecGuide.K-LiteCodecPack.Mega")
$Source = "winget"
