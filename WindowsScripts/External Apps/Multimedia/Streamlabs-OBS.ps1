# NAME: Streamlabs OBS
# DESCRIPTION: Installs Streamlabs OBS via WinGet. Use -Undo to uninstall.
# UNDOABLE: Yes
# UNDO_DESC: Uninstalls Streamlabs OBS using WinGet.
#
...
$PackageIds = @("Streamlabs.StreamlabsOBS")
$Source = "winget"
