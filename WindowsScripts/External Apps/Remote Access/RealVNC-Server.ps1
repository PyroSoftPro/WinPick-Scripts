# NAME: RealVNC Server
# DESCRIPTION: Installs RealVNC Server via WinGet. Use -Undo to uninstall.
# UNDOABLE: Yes
# UNDO_DESC: Uninstalls RealVNC Server using WinGet.
#
...
$AppName = "RealVNC Server"
$PackageIds = @("RealVNC.VNCServer")
$Source = "winget"
