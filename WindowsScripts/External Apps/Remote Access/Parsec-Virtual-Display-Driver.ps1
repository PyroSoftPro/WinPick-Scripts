...
# DESCRIPTION: Installs Parsec Virtual Display Driver via WinGet. Use -Undo to uninstall.
# UNDOABLE: Yes
# UNDO_DESC: Uninstalls Parsec Virtual Display Driver using WinGet.
#
...
$AppName = "Parsec Virtual Display Driver"
$PackageIds = @("Parsec.ParsecVDD")
$Source = "winget"
