...
# DESCRIPTION: Installs Parsec Virtual USB Adapter Driver via WinGet. Use -Undo to uninstall.
# UNDOABLE: Yes
# UNDO_DESC: Uninstalls Parsec Virtual USB Adapter Driver using WinGet.
#
...
$AppName = "Parsec Virtual USB Adapter Driver"
$PackageIds = @("Parsec.ParsecVUD")
$Source = "winget"
