...
# DESCRIPTION: Installs Chrome Remote Desktop via WinGet. Use -Undo to uninstall.
# UNDOABLE: Yes
# UNDO_DESC: Uninstalls Chrome Remote Desktop using WinGet.
#
...
$PackageIds = @("Google.ChromeRemoteDesktopHost")
$Source = "winget"
