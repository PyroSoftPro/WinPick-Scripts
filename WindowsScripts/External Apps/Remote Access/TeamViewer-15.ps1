# NAME: TeamViewer 15
# DESCRIPTION: Installs TeamViewer 15 via WinGet. Use -Undo to uninstall.
# UNDOABLE: Yes
# UNDO_DESC: Uninstalls TeamViewer 15 using WinGet.
#
...
$AppName = "TeamViewer 15"
$PackageIds = @("TeamViewer.TeamViewer")
$Source = "winget"
