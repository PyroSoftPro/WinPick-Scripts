...
# DESCRIPTION: Disables Windows Optional Feature "Microsoft-Hyper-V-Hypervisor". Use -Undo to enable.
# UNDOABLE: Yes
# UNDO_DESC: Enables Windows Optional Feature "Microsoft-Hyper-V-Hypervisor".
#
