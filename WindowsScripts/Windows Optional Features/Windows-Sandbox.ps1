...
# DESCRIPTION: Disables Windows Optional Feature "Containers-DisposableClientVM". Use -Undo to enable.
# UNDOABLE: Yes
# UNDO_DESC: Enables Windows Optional Feature "Containers-DisposableClientVM".
#
