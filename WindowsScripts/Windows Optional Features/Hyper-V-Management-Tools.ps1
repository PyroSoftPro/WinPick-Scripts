...
# DESCRIPTION: Disables Windows Optional Feature "Microsoft-Hyper-V-Tools-All". Use -Undo to enable.
# UNDOABLE: Yes
# UNDO_DESC: Enables Windows Optional Feature "Microsoft-Hyper-V-Tools-All".
#
