# NAME: Disable Settings Suggestions and Ads
# DESCRIPTION: Disables Settings suggestions and Microsoft 365 ads in Settings.
# UNDOABLE: No
# UNDO_DESC: N/A
#
...
try {
    Ensure-Admin
    Write-Log "Disabling Settings suggestions and ads..." "INFO"
    Import-RegFile "Regfiles\\Disable_Windows_Suggestions.reg"
    Import-RegFile "Regfiles\\Disable_Settings_365_Ads.reg"
