# NAME: Hide OneDrive in Explorer
# DESCRIPTION: Hides the OneDrive folder from the File Explorer navigation pane.
# UNDOABLE: No
# UNDO_DESC: N/A
#
...
try {
    Ensure-Admin
    Write-Log "Hiding OneDrive in File Explorer..." "INFO"
    Import-RegFile "Regfiles\\Hide_Onedrive_Folder.reg"
