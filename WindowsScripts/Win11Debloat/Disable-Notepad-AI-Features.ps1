...
# DESCRIPTION: Disables AI features in Windows Notepad.
# UNDOABLE: No
# UNDO_DESC: N/A
#
...
try {
    Ensure-Admin
    Write-Log "Disabling Notepad AI features..." "INFO"
    Import-RegFile "Regfiles\\Disable_Notepad_AI_Features.reg"
