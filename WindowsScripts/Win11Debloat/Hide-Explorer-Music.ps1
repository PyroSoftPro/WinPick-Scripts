# NAME: Hide Music in Explorer
# DESCRIPTION: Hides the Music folder from the File Explorer navigation pane.
# UNDOABLE: No
# UNDO_DESC: N/A
#
...
try {
    Ensure-Admin
    Write-Log "Hiding Music in File Explorer..." "INFO"
    Import-RegFile "Regfiles\\Hide_Music_Folder.reg"
