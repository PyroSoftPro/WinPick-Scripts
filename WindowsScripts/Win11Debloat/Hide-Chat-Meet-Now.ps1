...
# DESCRIPTION: Hides the Chat/Meet Now icon on the taskbar (Windows 10/11).
# UNDOABLE: No
# UNDO_DESC: N/A
#
...
try {
    Write-Log "Hiding Chat / Meet Now icon..." "INFO"
    Import-RegFile "Regfiles\\Disable_Chat_Taskbar.reg"
