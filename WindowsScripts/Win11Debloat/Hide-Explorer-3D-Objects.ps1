# NAME: Hide 3D Objects in Explorer
# DESCRIPTION: Hides the 3D Objects folder from the File Explorer navigation pane.
# UNDOABLE: No
# UNDO_DESC: N/A
#
...
try {
    Ensure-Admin
    Write-Log "Hiding 3D Objects in File Explorer..." "INFO"
    Import-RegFile "Regfiles\\Hide_3D_Objects_Folder.reg"
