...
# DESCRIPTION: Disables Microsoft Copilot and removes the Copilot app package.
# UNDOABLE: No
# UNDO_DESC: N/A
#
...
try {
    Ensure-Admin
    Write-Log "Disabling Microsoft Copilot..." "INFO"
    Import-RegFile "Regfiles\\Disable_Copilot.reg"
    Write-Log "Removing Copilot app package..." "INFO"
    Remove-AppxPackages @("Microsoft.Copilot")
