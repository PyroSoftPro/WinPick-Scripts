# NAME: Disable Telemetry, Activity History, and Ads
# DESCRIPTION: Disables telemetry/diagnostic data, activity history, app-launch tracking, and targeted ads.
# UNDOABLE: No
# UNDO_DESC: N/A
#
...
try {
    Ensure-Admin
    Write-Log "Disabling telemetry, activity history, and targeted ads..." "INFO"
    Import-RegFile "Regfiles\\Disable_Telemetry.reg"
