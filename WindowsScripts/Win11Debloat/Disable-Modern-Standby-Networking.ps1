...
# DESCRIPTION: Disables network connectivity during Modern Standby (if supported).
# UNDOABLE: No
# UNDO_DESC: N/A
#
...
try {
    Ensure-Admin
    Write-Log "Disabling Modern Standby networking..." "INFO"
    Import-RegFile "Regfiles\\Disable_Modern_Standby_Networking.reg"
