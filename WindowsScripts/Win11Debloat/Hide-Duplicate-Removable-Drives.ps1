...
# DESCRIPTION: Hides duplicate removable drive entries from the File Explorer navigation pane.
# UNDOABLE: No
# UNDO_DESC: N/A
#
...
try {
    Ensure-Admin
    Write-Log "Hiding duplicate removable drive entries..." "INFO"
    Import-RegFile "Regfiles\\Hide_duplicate_removable_drives_from_navigation_pane_of_File_Explorer.reg"
