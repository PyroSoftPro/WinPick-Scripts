...
# DESCRIPTION: Disables Game Bar integration and related popups.
# UNDOABLE: No
# UNDO_DESC: N/A
#
...
try {
    Ensure-Admin
    Write-Log "Disabling Game Bar integration..." "INFO"
    Import-RegFile "Regfiles\\Disable_Game_Bar_Integration.reg"
