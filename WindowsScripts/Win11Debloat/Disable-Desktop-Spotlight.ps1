...
# DESCRIPTION: Disables Windows Spotlight as a desktop background option.
# UNDOABLE: No
# UNDO_DESC: N/A
#
...
try {
    Ensure-Admin
    Write-Log "Disabling desktop spotlight..." "INFO"
    Import-RegFile "Regfiles\\Disable_Desktop_Spotlight.reg"
