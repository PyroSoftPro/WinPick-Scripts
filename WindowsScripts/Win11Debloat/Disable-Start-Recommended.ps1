# NAME: Disable Start Recommended
# DESCRIPTION: Disables the Recommended section in the Windows 11 Start menu.
# UNDOABLE: No
# UNDO_DESC: N/A
#
...
try {
    Ensure-Admin
    Write-Log "Disabling Start Recommended section..." "INFO"
    Import-RegFile "Regfiles\\Disable_Start_Recommended.reg"
