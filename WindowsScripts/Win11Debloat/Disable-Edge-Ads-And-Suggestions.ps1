# NAME: Disable Edge Ads and Suggestions
# DESCRIPTION: Disables Edge recommendations, MSN news feed, and related promotional content.
# UNDOABLE: No
# UNDO_DESC: N/A
#
...
try {
    Ensure-Admin
    Write-Log "Disabling Edge ads and suggestions..." "INFO"
    Import-RegFile "Regfiles\\Disable_Edge_Ads_And_Suggestions.reg"
