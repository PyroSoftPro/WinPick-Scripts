# NAME: Add Folders to This PC
# DESCRIPTION: Adds common folders (Desktop, Documents, Downloads, Music, Pictures, Videos) back to This PC.
# UNDOABLE: No
# UNDO_DESC: N/A
#
...
try {
    Ensure-Admin
    Write-Log "Adding common folders to This PC..." "INFO"
    Import-RegFile "Regfiles\\Add_All_Folders_Under_This_PC.reg"
