# NAME: Disable Telemetry and Diagnostic Data
# DESCRIPTION: Disables telemetry and diagnostic data collection.
# UNDOABLE: No
# UNDO_DESC: N/A
#
...
try {
    Ensure-Admin
    Write-Log "Disabling telemetry and diagnostic data..." "INFO"
