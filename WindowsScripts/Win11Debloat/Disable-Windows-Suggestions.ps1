...
# DESCRIPTION: Disables Windows tips, tricks, and suggestion content across Start, Settings, and notifications.
# UNDOABLE: No
# UNDO_DESC: N/A
#
...
try {
    Ensure-Admin
    Write-Log "Disabling Windows suggestions and tips..." "INFO"
