# NAME: Remove Mail, Calendar, and People
# DESCRIPTION: Removes Mail, Calendar, and People app packages for all users.
# UNDOABLE: No
# UNDO_DESC: N/A
#
...
try {
    Ensure-Admin
    Write-Log "Removing Mail, Calendar, and People..." "INFO"
    Remove-AppxPackages @("microsoft.windowscommunicationsapps", "Microsoft.People")
