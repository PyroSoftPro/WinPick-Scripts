# NAME: Disable App Launch Tracking and Ads
# DESCRIPTION: Disables app-launch tracking and targeted ads.
# UNDOABLE: No
# UNDO_DESC: N/A
#
...
try {
    Ensure-Admin
    Write-Log "Disabling app launch tracking and targeted ads..." "INFO"
