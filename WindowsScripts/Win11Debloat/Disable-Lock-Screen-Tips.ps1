...
# DESCRIPTION: Disables lock screen tips, tricks, and rotating overlays.
# UNDOABLE: No
# UNDO_DESC: N/A
#
...
try {
    Ensure-Admin
    Write-Log "Disabling lock screen tips..." "INFO"
    Import-RegFile "Regfiles\\Disable_Lockscreen_Tips.reg"
