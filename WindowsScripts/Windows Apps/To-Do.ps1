...
# DESCRIPTION: Removes Microsoft To Do for all users and deprovisions it. Use -Undo to reinstall via WinGet.
# UNDOABLE: Yes
# UNDO_DESC: Reinstalls Microsoft To Do using WinGet (Microsoft Store).
#
...
function Remove-ToDo {
    ...
    Write-Log "Removing installed Microsoft To Do packages..." "INFO"
    ...
    Write-Log "Removing provisioned Microsoft To Do package..." "INFO"
...
function Install-ToDo {
    ...
    if ($existing) {
        Write-Log "Microsoft To Do is already installed. No action taken." "INFO"
        return
    }
    ...
    Write-Log "Installing Microsoft To Do via WinGet..." "INFO"
    $args = @(
        "install",
        "--id", $wingetId,
        "--source", "msstore",
    ...
    Write-Log "Microsoft To Do installed successfully." "INFO"
}

try {
    Ensure-Admin
    if ($Undo) {
        Write-Log "Starting undo operation (reinstall Microsoft To Do)..." "INFO"
        Install-ToDo
    } else {
