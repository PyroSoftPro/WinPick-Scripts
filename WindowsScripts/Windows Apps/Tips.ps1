# NAME: Tips
# DESCRIPTION: Removes Tips for all users and deprovisions it.
# UNDOABLE: No
...
function Remove-Tips {
    ...
    Write-Log "Removing installed Tips packages..." "INFO"
    ...
    Write-Log "Removing provisioned Tips package..." "INFO"
...
try {
    Ensure-Admin
    if ($Undo) {
        Write-Log "Undo is not supported for Tips." "ERROR"
        exit 1
    }
