# NAME: Paint 3D
# DESCRIPTION: Removes Paint 3D for all users and deprovisions it.
# UNDOABLE: No
...
function Remove-Paint3D {
    ...
    Write-Log "Removing installed Paint 3D packages..." "INFO"
    ...
    Write-Log "Removing provisioned Paint 3D package..." "INFO"
...
try {
    Ensure-Admin
    if ($Undo) {
        Write-Log "Undo is not supported for Paint 3D." "ERROR"
        exit 1
    }
