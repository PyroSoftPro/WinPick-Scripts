# NAME: Skype
# DESCRIPTION: Removes Skype for all users and deprovisions it.
# UNDOABLE: No
...
function Remove-Skype {
    ...
    Write-Log "Removing installed Skype packages..." "INFO"
    ...
    Write-Log "Removing provisioned Skype package..." "INFO"
...
try {
    Ensure-Admin
    if ($Undo) {
        Write-Log "Undo is not supported for Skype (package is retired)." "ERROR"
        exit 1
    }
