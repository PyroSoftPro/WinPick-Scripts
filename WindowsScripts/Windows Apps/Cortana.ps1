# NAME: Cortana
# DESCRIPTION: Removes Cortana for all users and deprovisions it.
# UNDOABLE: No
...
function Remove-Cortana {
    ...
    Write-Log "Removing installed Cortana packages..." "INFO"
    ...
    Write-Log "Removing provisioned Cortana package..." "INFO"
...
try {
    Ensure-Admin
    if ($Undo) {
        Write-Log "Undo is not supported for Cortana (package is deprecated)." "ERROR"
        exit 1
    }
