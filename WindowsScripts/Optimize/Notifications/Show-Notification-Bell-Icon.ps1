...
# DESCRIPTION: Hides the notification bell icon. Use -Undo to show it.
# UNDOABLE: Yes
# UNDO_DESC: Shows the notification bell icon.
...
try {
    ...
    if ($Undo) {
        ...
        Write-Log "Notification bell icon shown." "INFO"
    } else {
        Set-ItemProperty -Path $RegistryPath -Name $ValueName -Value 0 -Type DWord -Force
        Write-Log "Notification bell icon hidden." "INFO"
    }
