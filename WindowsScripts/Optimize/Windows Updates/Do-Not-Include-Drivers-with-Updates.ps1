...
# DESCRIPTION: Excludes driver updates from Windows Update. Use -Undo to include drivers.
# UNDOABLE: Yes
# UNDO_DESC: Includes driver updates in Windows Update.
...
try {
    ...
    if ($Undo) {
        ...
        Write-Log "Driver updates included in Windows Update." "INFO"
    } else {
        ...
        Write-Log "Driver updates excluded from Windows Update." "INFO"
    }
