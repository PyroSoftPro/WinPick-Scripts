...
# DESCRIPTION: Disables smooth scrolling in list boxes. Use -Undo to enable it.
# UNDOABLE: Yes
# UNDO_DESC: Enables smooth scrolling in list boxes.
...
try {
    ...
    if ($Undo) {
        ...
        Write-Log "Smooth scrolling in list boxes enabled." "INFO"
    } else {
        Set-UserPreferencesMaskBit -Enable $false
        Write-Log "Smooth scrolling in list boxes disabled." "INFO"
    }
