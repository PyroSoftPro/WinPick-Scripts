...
# DESCRIPTION: Disables the Software Quality Metrics task. Use -Undo to enable it.
# UNDOABLE: Yes
# UNDO_DESC: Enables the Software Quality Metrics task.
...
try {
    ...
    if ($Undo) {
        ...
        Write-Log "Software Quality Metrics task enabled." "INFO"
    } else {
        Set-TaskState -Name $TaskName -Enable $false
        Write-Log "Software Quality Metrics task disabled." "INFO"
    }
