...
# DESCRIPTION: Enables window shadows. Use -Undo to disable them.
# UNDOABLE: Yes
# UNDO_DESC: Disables window shadows.
...
try {
    ...
    if ($Undo) {
        ...
        Write-Log "Window shadows disabled." "INFO"
    } else {
        Set-UserPreferencesMaskBit -Enable $true
        Write-Log "Window shadows enabled." "INFO"
    }
