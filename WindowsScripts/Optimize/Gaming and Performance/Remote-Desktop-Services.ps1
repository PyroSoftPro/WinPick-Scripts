...
# DESCRIPTION: Sets Remote Desktop Services to Manual. Use -Undo to set it to Automatic.
# UNDOABLE: Yes
# UNDO_DESC: Sets Remote Desktop Services to Automatic.
...
try {
    ...
    if ($Undo) {
        ...
        Write-Log "Remote Desktop Services set to Automatic." "INFO"
    } else {
        Set-ItemProperty -Path $RegistryPath -Name $ValueName -Value 3 -Type DWord -Force
        Write-Log "Remote Desktop Services set to Manual." "INFO"
    }
