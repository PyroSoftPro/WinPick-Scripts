...
# DESCRIPTION: Disables the Program Data Updater scheduled task. Use -Undo to enable it.
# UNDOABLE: Yes
# UNDO_DESC: Enables the Program Data Updater scheduled task.
...
try {
    ...
    if ($Undo) {
        ...
        Write-Log "Program Data Updater task enabled." "INFO"
    } else {
        Set-TaskState -Name $TaskName -Enable $false
        Write-Log "Program Data Updater task disabled." "INFO"
    }
