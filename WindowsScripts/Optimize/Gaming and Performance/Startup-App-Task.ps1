...
# DESCRIPTION: Disables the Startup App task. Use -Undo to enable it.
# UNDOABLE: Yes
# UNDO_DESC: Enables the Startup App task.
...
try {
    ...
    if ($Undo) {
        ...
        Write-Log "Startup App task enabled." "INFO"
    } else {
        Set-TaskState -Name $TaskName -Enable $false
        Write-Log "Startup App task disabled." "INFO"
    }
